      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto w-full">
        {reasons.map((r, i) => (
          <motion.div
            ...
            className="clean-card p-5 flex items-start gap-4 group hover:border-eco-light/60"
          >
            <div className="flex-shrink-0 num-badge">
              {r.num}
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <p className="font-bold text-gray-800">{r.title}</p>
                <r.icon size={14} className="text-gray-300 group-hover:text-eco-dark transition-colors flex-shrink-0" />
              </div>
